...
class TestTodoManager(unittest.TestCase):
    ...
    def test_5_get_children(self):
        ...
        _unrelevant_child_todo_1 = self.manager.add_todo("Unrelevant Child Task 1", "This is an unrelevant child task.", parent_todo.uuid)
        _unrelevant_parent_todo_2 = self.manager.add_todo("Unrelevant Parent Task 2", "This is an unrelevant parent task.")
        _unrelevant_child_todo_2 = self.manager.add_todo("Unrelevant Child Task 2", "This is an unrelevant child task.", parent_todo.uuid)
    ...
    def test_6_get_children_recursive(self):
        ...
        unrelevant_todo_1 = self.manager.add_todo("8", "unrelevant parent 1")
        unrelevant_todo_2 = self.manager.add_todo("9", "unrelevant parent 2", parent_uuid=todo_1.uuid)
        unrelevant_todo_3 = self.manager.add_todo("10", "unrelevant todo", parent_uuid=todo_6.uuid)
